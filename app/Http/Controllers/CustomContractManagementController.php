...
class CustomContractManagementController extends Controller
{
    ...
    public function getCustomContractManagement(Request $request)
    {
            ...
            ->addColumn('action', function($row) use($request){
                ...
                $btn = '<div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="' . route('custom-contract-management-edit', ['id' => $row->id, 'tab' => $request->tab]) . '">Edit</a>
