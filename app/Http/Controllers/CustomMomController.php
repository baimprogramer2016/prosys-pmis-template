...
class CustomMomController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            return view('pages.custom-mom.report', [
    ...
    public function getCustomMom(Request $request)
    {
            ...
            return DataTables::of($data)
                ->addColumn('action', function ($row) use ($request) {
                    ...
                    if (Gate::allows('edit_minutes_of_meeting')) {
                        $editBtn = ' <a class="dropdown-item" href="' . route('custom-mom-edit', ['id' => $row->id, 'tab' => $request->tab]) . '">Edit</a>';
                    }
    ...
    public function viewTambah(Request $request)
    {
        try {
            ...
            $title = MasterCustom::where('tab', $request->tab)->first();
            return view('pages.custom-mom.report-tambah', [
                "title" => $title->name,
            ]);
        } catch (Throwable $e) {
            // Tangani error
    ...
    public function viewEdit(Request $request, $id)
    {
        ...
        try {
            ...
            $title = MasterCustom::where('tab', $request->tab)->first();
            return view('pages.custom-mom.report-edit', [
                "document" => $document,
                "title" => $title->name
            ]);
        } catch (Throwable $e) {
    ...
    public function updateUploads(Request $request, $id)
    {
        ...
        $docHistory->typeofmeeting = $doc->typeofmeeting;
        $docHistory->meetinglocation = $doc->meetinglocation;
    ...
    public function pdf(Request $request, $id)
    {
        try {
            ...
            return view('pages.custom-mom.report-pdf', [
                "document" => $document,
            ]);
        } catch (Throwable $e) {
            // Tangani error
    ...
    public function share(Request $request, $id)
    {
        ...
        try {
            ...
            $document = $tableCustom->find($id);
            return view('pages.custom-mom.report-share', [
                "document" => $document,
            ]);
        } catch (Throwable $e) {
            // Tangani error
    ...
    public function viewDelete(Request $request, $id)
    {
        ...
        try {
            ...
            return view('pages.custom-mom.report-delete', [
                "document" => $document,
                "tab" => $tab
            ]);
        } catch (Throwable $e) {
    ...
    public function history(Request $request, $id)
    {
        try {
            ...
            return view('pages.custom-mom.report-history', [
                "documents" => $document,
            ]);
        } catch (Throwable $e) {
            // Tangani error
