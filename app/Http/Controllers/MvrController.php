...
class MvrController extends Controller
{
    ...
    public function getMvr(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            ->addColumn('action', function($row) {
                ...
                $editBtn = '';
                if (Gate::allows('edit_mvr')) {
                    $editBtn = ' <a class="dropdown-item" href="'.route('mvr-edit', $row->id).'">Edit</a>';
                }
            
                // Tombol Delete (Hanya tampil jika user memiliki izin 'delete_schedule')
                $deleteBtn = '';
                if (Gate::allows('delete_mvr')) {
    ...
    public function tambah(Request $request){
        try{
            ...
            return view('pages.mvr.mvr-tambah');
        }catch (Throwable $e) {
            // Tangani error
            return response()->json([
                'message' => 'Terjadi kesalahan saat menyimpan data.',
    ...
    public function saveUploads(Request $request)
    {
        ...
        foreach ($uploadedFiles as $file) {
            ...
            $newPath = str_replace('temp', 'public/mvr', $file['path']);
    ...
    public function viewEdit(Request $request, $id){
        ...
        try{
            $document = Mvr::find($id);
        
          return view('pages.mvr.mvr-edit',[
            "document" => $document
          ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $doc = Mvr::find($id);
            ...
            //insert ke history
            $docHistory = new MvrHistory();
            $docHistory->mvr_id = $doc->id;
        ...
        if (!empty($uploadedFiles) && is_array($uploadedFiles)) {
            ...
            $newPath = str_replace('temp', 'public/mvr', $uploadedFiles[0]['path']);
    ...
    public function viewDelete(Request $request, $id){
        ...
        try{
            $document = Mvr::find($id);
            return view('pages.mvr.mvr-delete', [
                "document" => $document,
            ]);
        }catch (Throwable $e) {
            // Tangani error
    ...
    public function share(Request $request, $id){
        ...
        try{
            $document = Mvr::find($id);
            return view('pages.mvr.mvr-share', [
                "document" => $document,
            ]);
        }catch (Throwable $e) {
            // Tangani error
    ...
    public function history(Request $request, $id){ 
        try{
            $document = mvrHistory::where('mvr_id', $id)->get();
            return view('pages.mvr.mvr-history', [
                "documents" => $document,
            ]);
        }catch (Throwable $e) {
            // Tangani error
