            ...
            <a href="{{ route('gantt-chart') }}">
              ...
              <p>Task Progress</p>
                      ...
                      <div class="collapse {{ Request::is('document-engineer*') || Request::is('document-engineer') ? 'show' : '' }}"
                          ...
                          <ul class="nav nav-collapse">
                              ...
                              @can('view_doc_engineering_mdr')
                                  <li
                                      class="{{ Request::is('document-engineer-master-deliverables-register') ? 'active' : '' }}">
                              ...
                              @can('view_doc_engineering_ded')
                                  <li
                                      class="{{ Request::is('document-engineer-detail-engineering-design') ? 'active' : '' }}">
                  ...
                  <li class="nav-item">
                      ...
                      <div class="collapse {{ Request::is('report*') || Request::is('rfi*') || Request::is('mvr*') || Request::is('mrr*') ? 'show' : '' }}"
                          id="report">
                          <ul class="nav nav-collapse">
