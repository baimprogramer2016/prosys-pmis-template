...
<div class="page-inner">
    ...
    >
      ...
      <div class="ms-md-auto py-2 py-md-0">
        @can('add_photographic')
        <a href="{{ route('custom-photographic-tambah',["tab" => request('tab')]) }}"  class="btn btn-primary btn-round">Tambah</a>
        @endcan
       </div>
    </div>
    <div class="row">
...
function viewDelete(param){
  ...
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('custom-photographic-delete', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
      },
...
function viewShare(param){
  ...
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('custom-photographic-share', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
      },
...
function viewPdf(param){
  ...
  $(".modal-content").html("");
  $.ajax({
    url: "{{ route('custom-photographic-pdf', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
      type: "GET",
      data: {
        tab:tab 
      },
 ...
 $(document).ready(function() {
  var table = $('.table').DataTable({
          ...
          language : {
            ...
            ajax: {
                url: "{{ route('get-custom-photographic', ['tab' => request('tab')]) }}",
            },
