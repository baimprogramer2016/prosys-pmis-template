                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control form-control-sm" id="type" name="type">
                                            @foreach ($data_type as $item_type)
                                                <option value="{{ $item_type->description }}">
                                                    {{ ucwords($item_type->description) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="icon"
                                            name="icon" placeholder="fas fa-arrow-left">
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control form-control-sm" id="parent" name="parent">
                                            ...
                                            @foreach ($data_parent as $item_parent)
                                                <option value="{{ $item_parent->id }}">{{ ucwords($item_parent->name) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        @endforeach --}}
                                    ...
                                    <div class="col-md-3 d-flex align-items-end mb-2 justify-content-start">
                                        <button type="submit" id="save" name="save"
                                            class="btn btn-sm btn-primary">Create Menu</button>
                                    </div>
    ...
    @push('bottom')
        ...
        <script>
            ...
            function viewDelete(param) {
                $(".modal-content").html("");
                $.ajax({
                    url: "{{ route('master-custom-delete', ':id') }}".replace(':id',
