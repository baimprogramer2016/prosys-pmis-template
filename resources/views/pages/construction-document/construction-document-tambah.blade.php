    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2">Construction Document / Upload</h6>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    <label for="tanggal" class="form-label strong">Tanggal</label>
                                    <input type="date" class="form-control" id="tanggal" name="tanggal"
                                        value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                                </div>
                                <div class=" mb-3">
                                    <label for="discipline" class="form-label strong">Discipline</label>
                                ...
                                <div class=" mb-3">
                                    <label for="category" class="form-label strong">Category</label>
...
@push('bottom')
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                $.ajax({
                    url: "{{ route('construction-document-save-uploads') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
