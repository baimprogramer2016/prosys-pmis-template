        ...
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            ...
            <div class="ms-md-auto py-2 py-md-0">
                @can('view_construction_upload')
                    <a href="{{ route('construction-document-tambah') }}" class="btn btn-primary btn-round">Tambah</a>
                @endcan
            </div>
...
@push('bottom')
    ...
    <script>
        function viewModal(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('construction-document-approve-modal', ':id') }}".replace(':id',
        ...
        function viewDelete(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('construction-document-delete', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function viewShare(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('construction-document-share', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function viewPdf(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('construction-document-pdf', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function viewHistory(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('construction-document-history', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
