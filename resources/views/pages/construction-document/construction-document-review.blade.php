...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Construction Document / Review</h6>
...
function viewModal(param){
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('construction-document-review-modal', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    headers: {
...
$.ajax({
 ...
 $(document).ready(function() {
  var table = $('.table').DataTable({
          ...
          ajax: {
            url : "{{ route('get-construction-document',['field' => 'verifikasi', 'status' => 'check']) }}",
          },
