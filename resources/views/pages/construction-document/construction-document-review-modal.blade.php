<div class="modal-header">
    ...
    <h5 class="modal-title" id="modalTambahLabel">Document Review</h5>
   ...
   emailApproval();
    ...
    $("#reviewData").on("click", function() {
      ...
      let description = $("#description").val();
        ...
        $.ajax({
          url: "{{ route('construction-document-review-update', ':id') }}".replace(':id', dataId), // Ganti dengan route yang sesuai
