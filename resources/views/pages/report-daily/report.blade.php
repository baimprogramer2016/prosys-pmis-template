...
@push('bottom')
    ...
    <script>
        function viewDelete(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('report-daily-delete', ':id') }}".replace(':id',
        ...
        function viewShare(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('report-daily-share', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function viewPdf(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('report-daily-pdf', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function viewHistory(param) {
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('report-daily-history', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
