...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Schedule Management / Upload</h6>
      </div>
      <div onClick="addView()" class="ms-md-auto py-2 py-md-0">
        <a href="{{ route('schedule-management') }}"  class="btn btn-primary btn-round">Daftar</a>
      </div>
    </div>
    <div class="row">
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    $.ajax({
      url: "{{ route('schedule-management-save-uploads') }}",
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
