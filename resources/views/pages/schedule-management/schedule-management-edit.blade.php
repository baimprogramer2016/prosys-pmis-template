...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Schedule Management / Edit</h6>
      </div>
      <div onClick="addView()" class="ms-md-auto py-2 py-md-0">
        {{-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> --}}
        <a href="{{ route('schedule-management') }}"  class="btn btn-primary btn-round">Document</a>
      </div>
    </div>
    <div class="row">
      ...
      <div class="card ">   
        <div class="card-body">
          ...
          <form action="{{ route('schedule-management-upload-temp')}}" class="dropzone mt-3" id="myDropzone">
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    $.ajax({
      url: "{{ route('schedule-management-update',':id') }}".replace(':id', id_edit),
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
