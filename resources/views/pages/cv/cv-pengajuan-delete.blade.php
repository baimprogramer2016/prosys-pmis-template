...
<div class="modal-body">
    <form id="formData">
        <div class="mb-3">
            ...
            <input type="hidden" id="data_id" name="data_id" value="{{ $document->id }}">
            <!-- Hidden input for ID -->
            <input type="text" readonly class="form-control" value="{{ $document->description }}">
        </div>
    </form>
</div>
...
<script>
    ...
    $("#deleteData").on("click", function() {
        ...
        $.ajax({
            url: "{{ route('cv-pengajuan-deleted', ':id') }}".replace(':id',
