                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <form action="{{ route('custom-personnel-hr-upload-temp') }}" class="dropzone mt-3"
                                    id="myDropzone">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <textarea class="form-control" id="document_number" name="document_number" placeholder="Nomor Dokumen">{{ $document->document_number }}</textarea>

                                </div>
                                <div class=" mb-3">
                                    <label for="start_date" class="form-label strong">Title</label>
                                    <textarea class="form-control" id="description" name="description" placeholder="Title">{{ $document->description }}</textarea>
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                ...
                $.ajax({
                    url: "{{ route('custom-personnel-hr-update-uploads', ':id') }}".replace(':id',
                        id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
