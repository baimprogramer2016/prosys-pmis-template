...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Procurement & Logistic / {{ Ucwords(str_replace('_',' ',request('tab'))) }}/ Edit</h6>
      </div>
    ...
    <div class="row">
      ...
      <div class="card ">   
        <div class="card-body">
          ...
          <form action="{{ route('custom-procurement-logistic-upload-temp')}}" class="dropzone mt-3" id="myDropzone">
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    ...
    $.ajax({
      url: "{{ route('custom-procurement-logistic-update-uploads',':id') }}".replace(':id', id_edit),
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
