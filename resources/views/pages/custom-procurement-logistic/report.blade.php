...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Procurement & Logistic / {{ Ucwords(str_replace('_',' ',request('tab'))) }}  </h6>
...
function viewDelete(param){
  ...
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('custom-procurement-logistic-delete', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
      },
...
function viewShare(param){
  ...
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('custom-procurement-logistic-share', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
      },
...
function viewPdf(param){
  ...
  $(".modal-content").html("");
  $.ajax({
    url: "{{ route('custom-procurement-logistic-pdf', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
      type: "GET",
      data: {
        tab:tab 
      },
 ...
 $(document).ready(function() {
  var table = $('.table').DataTable({
          ...
          language : {
            ...
            ajax: {
                url: "{{ route('get-custom-procurement-logistic', ['tab' => request('tab')]) }}",
            },
...
function viewHistory(param){
  ...
  $(".modal-content").html("");
  $.ajax({
  url: "{{ route('custom-procurement-logistic-history', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
    },
