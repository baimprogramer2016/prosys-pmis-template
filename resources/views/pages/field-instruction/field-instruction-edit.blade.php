    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2">Field Instruction / Edit</h6>
            </div>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="card ">
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                <div class="alert-warning text-center">Hanya bisa Upload 1 File
                                    <strong>Kosongkan jika
                                        Document
                                        tidak dirubah</strong>
                                </div>
                                <form action="{{ route('field-instruction-upload-temp') }}" class="dropzone mt-3"
                                    id="myDropzone">
...
@push('bottom')
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                $.ajax({
                    url: "{{ route('field-instruction-update-uploads', ':id') }}".replace(':id', id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
