          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col col-stats ms-3 ms-sm-0 d-flex">
                <div class="numbers">
                  <h4 class="card-title">Input Issue</h4>
                </div>
        ...
        <div class="card-body">
          ...
          <div class="align-items-center mb-3 mt-3   p-3 row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="date" class="form-control" id="closure_date" name="closure_date" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
            </div>
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    $.ajax({
      url: "{{ route('issue-log-save-uploads') }}",
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
