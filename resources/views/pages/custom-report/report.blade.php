    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            ...
            <div class="ms-md-auto py-2 py-md-0">
                @can($permission_add)
                    <a href="{{ route('custom-report-tambah', ['tab' => request('tab')]) }}"
...
@push('bottom')
    ...
    <script>
        function viewDelete(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-report-delete', ':id') }}".replace(':id',
        ...
        function viewShare(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-report-share', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewPdf(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-report-pdf', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewHistory(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-report-history', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
