                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <form action="{{ route('custom-report-upload-temp') }}" class="dropzone mt-3"
                                    id="myDropzone">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    <label for="start_date" class="form-label strong">Type If Report</label>
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                ...
                $.ajax({
                    url: "{{ route('custom-report-save-uploads') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
