    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2">Minutes Of Meeting</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
                {{-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> --}}
                <a href="{{ route('mom') }}" class="btn btn-primary btn-round">Daftar</a>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0 d-flex">
                                <div class="numbers">
                                    <h4 class="card-title">Edit Mom</h4>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <form action="{{ route('mom-upload-temp') }}" class="dropzone mt-3" id="myDropzone">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <textarea class="form-control" id="document_number" name="document_number">{{ $document->document_number }}</textarea>
                                ...
                                <div class=" mb-3">
                                    <label for="start_date" class="form-label strong">Type Of Meeting</label>
                                    <input type="text" class="form-control" id="typeofmeeting" name="typeofmeeting"
                                        value="{{ $document->typeofmeeting }}">
                                </div>

                                <div class=" mb-3">
                                    <label for="start_date" class="form-label strong">Meeting Location</label>
                                    <input type="text" class="form-control" id="meetinglocation" name="meetinglocation"
                                        value="{{ $document->meetinglocation }}">
                                </div>
...
@push('bottom')
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            let typeofmeeting = $("#typeofmeeting").val();
            let meetinglocation = $("#meetinglocation").val();
            ...
            if (typeofmeeting === "") {
                $("#typeofmeeting").addClass("is-invalid");
                valid = false;
            }
            ...
            if (valid == true) {
                $.ajax({
                    url: "{{ route('mom-update', ':id') }}".replace(':id', id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
