    ...
    <div class="row">
      ...
      <div class="card ">   
        <div class="card-body">
          ...
          <form action="{{ route('custom-invoice-record-upload-temp')}}" class="dropzone mt-3" id="myDropzone">
          ...
          <div class="align-items-center mb-3 mt-3   p-3 row">
            ...
            <div class="col-md mb-3">
              <label for="start_date" class="form-label strong">No. Invoice</label>
              <input type="text" class="form-control" id="no_invoice" name="no_invoice" value="{{$document->no_invoice}}">
            </div>
            <div class="col-md mb-3">
            ...
            <div class="col-md-4 mb-3">
              <label for="start_date" class="form-label strong">Invoice Date</label>
              <input type="date" class="form-control" id="invoice_date" name="invoice_date" value="{{ \Carbon\Carbon::parse($document->invoice_date)->format('Y-m-d') }}">
            </div>
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    ...
    $.ajax({
      url: "{{ route('custom-invoice-record-update-uploads',':id') }}".replace(':id', id_edit),
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
