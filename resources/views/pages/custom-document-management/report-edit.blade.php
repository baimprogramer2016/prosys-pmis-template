...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Document Management / {{ request("tab")}} / Edit</h6>
      </div>
      <div onClick="addView()" class="ms-md-auto py-2 py-md-0">
        {{-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> --}}
        {{-- <a href="{{ route('document-engineer-check') }}"  class="btn btn-primary btn-round">Document</a> --}}
      </div>
    </div>
    <div class="row">
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    ...
    $.ajax({
      url: "{{ route('custom-document-management-update-uploads',':id') }}".replace(':id', id_edit),
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
