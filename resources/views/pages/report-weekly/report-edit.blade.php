    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2">Report Weekly / Edit</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
                {{-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> --}}
                <a href="{{ route('report-weekly') }}" class="btn btn-primary btn-round">Daftar</a>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <form action="{{ route('report-weekly-upload-temp') }}" class="dropzone mt-3"
                                    id="myDropzone">
...
@push('bottom')
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                $.ajax({
                    url: "{{ route('report-weekly-update', ':id') }}".replace(':id', id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
