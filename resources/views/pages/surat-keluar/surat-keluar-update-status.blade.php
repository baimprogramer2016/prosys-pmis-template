  ...
  <div class="modal-body">
    <form id="formData">
      <div class="mb-3">
        ...
        <input type="text" readonly class="form-control" value="{{ $data_surat->document_number }}">
      </div>
    </form>
  </div>
  ...
  <script>
    ...
    $("#updateData").on("click", function() {
      ...
      let dataId = $("#data_id").val();
        ...
        $.ajax({
          url: "{{ route('surat-keluar-updated-status', ':id') }}".replace(':id', dataId), // Ganti dengan route yang sesuai
