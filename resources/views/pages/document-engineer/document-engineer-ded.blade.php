...
<div class="page-inner">
    ...
    >
      <div class="d-flex align-items-center gap-4">
        ...
        <h6 class="op-7 mb-2">Document Management / Detail Engineering Design</h6>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col col-stats ms-3 ms-sm-0 d-flex">
                <div class="numbers">
                  <h4 class="card-title">Detail Engineering Design</h4>
                </div>
...
function viewModal(param){
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('document-engineer-approve-modal', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    headers: {
...
$.ajax({
 ...
 $(document).ready(function() {
  var table = $('.table').DataTable({
          ...
          ajax: {
            url : "{{ route('get-document-engineer',['field' => 'design', 'status' => '2']) }}",
          },
