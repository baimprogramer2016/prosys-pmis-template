                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ms-3 ms-sm-0 d-flex">
                                        <div class="numbers">
                                            <h4 class="card-title">
                                                {{ Ucwords(str_replace('Piling', '', str_replace('piling', '', str_replace('_', ' ', $title)))) }}
                                            </h4>
                                        </div>
                            ...
                            <table class="table table-bordered" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="bg-th">Type Of Meeting</th>
                                        <th class="bg-th">Meeting Location</th>
...
@push('bottom')
    ...
    <script>
        function viewDelete(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-mom-delete', ':id') }}".replace(':id',
        ...
        function viewShare(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-mom-share', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewPdf(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-mom-pdf', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        $(document).ready(function() {
            var table = $('.table').DataTable({
                ...
                ajax: {
                    url: "{{ route('get-custom-mom', ['tab' => request('tab')]) }}",
                },
        ...
        function viewHistory(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-mom-history', ':id') }}".replace(':id',
                    param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
