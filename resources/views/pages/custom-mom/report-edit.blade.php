    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2"> {{ Ucwords(str_replace('_', ' ', $title)) }} / Edit</h6>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <form action="{{ route('custom-mom-upload-temp') }}" class="dropzone mt-3" id="myDropzone">
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                ...
                $.ajax({
                    url: "{{ route('custom-mom-update-uploads', ':id') }}".replace(':id', id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
