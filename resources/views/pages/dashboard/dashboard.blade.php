                        ...
                        <div class="d-flex flex-wrap align-items-center w-70 justify-content-end">
                            ...
                            <div class="me-3 mb-2 mb-lg-0 d-flex align-items-center">
                                ...
                                <input type="date" id="tanggal_awal" class="form-control form-control-sm"
                                    style="width: 150px;" value="{{ $min_date }}">
                            </div>
                            <div class="me-3 mb-2 mb-lg-0 d-flex align-items-center">
                                ...
                                <input type="date" id="tanggal_akhir" class="form-control form-control-sm"
                                    style="width: 150px;" value="{{ $max_date }}">
                            </div>
                            <div class="d-flex">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="date" id="start_date" class="form-control form-control-sm me-3"
                                style="width: 150px;">

                            <label for="end_date" class="me-2 mb-0">Tanggal Akhir:</label>
                            <input type="date" id="end_date" class="form-control form-control-sm me-3"
                                style="width: 150px;">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            {{-- <label for="start_date" class="me-2 mb-0">Tanggal Awal:</label> --}}
                            <input type="date" id="start_date_document_management"
                                class="form-control form-control-sm me-3" style="width: 100%;">

                            {{-- <label for="end_date" class="me-2 mb-0">Tanggal Akhir:</label> --}}
                            <input type="date" id="end_date_document_management"
                                class="form-control form-control-sm me-3" style="width: 100%;">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            {{-- <label for="start_date" class="me-2 mb-0">Tanggal Awal:</label> --}}
                            <input type="date" id="start_date_procurement_logistic"
                                class="form-control form-control-sm me-3" style="width: 100%;">

                            {{-- <label for="end_date" class="me-2 mb-0">Tanggal Akhir:</label> --}}
                            <input type="date" id="end_date_procurement_logistic"
                                class="form-control form-control-sm me-3" style="width: 100%;">
            ...
            {{-- <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <label for="start_date" class="me-2 mb-0">Tanggal Awal:</label>
                            <input type="date" id="start_date_drawing" class="form-control form-control-sm me-3"
                                style="width: 150px;">

                            <label for="end_date" class="me-2 mb-0">Tanggal Akhir:</label>
                            <input type="date" id="end_date_drawing" class="form-control form-control-sm me-3"
                                style="width: 150px;">
...
@push('bottom')
    ...
    <script>
        ...
        $("#filterBtnDocumentMangement").click(function() {
            ...
            getDataDocumentManagement($("#start_date_document_management").val(), $("#end_date_document_management")
                .val());
        });
        ...
        $("#filterBtnProcurementLogistic").click(function() {
            ...
            getDataProcurementLogistic($("#start_date_procurement_logistic").val(), $(
                "#end_date_procurement_logistic").val());
        });
        ...
        function curveChart(param) {
            ...
            const month = String(today.getMonth() + 1).padStart(2,
                '0'); // Menambahkan angka 1 karena getMonth() dimulai dari 0
                ...
                options: {
                    ...
                    scales: {
                        ...
                        y: {
                            ...
                            grid: {
                                color: function(ctx) {
                                    return ctx.tick.value % 40 === 0 ? "rgba(255, 99, 132, 0.2)" :
                                        "rgba(75, 192, 192, 0.1)";
                                }
                            }
                        }
