...
@push('top')
    ...
    <style>
        ...
        .con {
            border-radius: 20px;
            box-shadow: 0px 8px 12px rgba(239, 236, 236, 0.1);
            /* Efek shadow */
                    ...
                    <a href="{{ route('presensi') }}">
                        <div class="card p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-1">
                                        <b> <small>Live Attendance</small></b>
                                    </h5>
                    ...
                    <a href="{{ route('schedule-management') }}">
                        <div class="card p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-1">
                                        <b> <small>Schedule Management</small></b>
                                    </h5>
                    ...
                    <a href="{{ route('sop') }}">
                        <div class="card p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-1">
                                        <b> <small> Project Procedure (SOP)</small></b>
                                    </h5>
                    ...
                    <a href="{{ route('construction-document') }}">
                        <div class="card p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-1">
                                        <b> <small>Construction Document</small></b>
                                    </h5>
                                    <small class="text-muted">Document Management</small>
                                </div>
                            </div>
                    ...
                    <a href="{{ route('field-instruction') }}">
                        <div class="card p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-1">
                                        <b> <small>Field Instruction</small></b>
                                    </h5>
                                    <small class="text-muted">Document Management</small>
                                </div>
                            </div>
