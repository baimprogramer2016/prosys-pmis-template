              ...
              <div class="card-body">
                  ...
                  <div class="form-row d-flex align-items-center row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="password" class="form-control form-control-sm" id="new_password" name="new_password" onkeyup="return checkPass()">
                      <input type="hidden" class="form-control form-control-sm" id="username" name="username" value="{{ Auth::user()->username }}" >
                    </div>
                    <div class="form-group col-md-3">
                      <label for="confirm_password">Confirm Password</label>
                      <input type="password" class="form-control form-control-sm" id="confirm_password" name="confirm_password"  onkeyup="return checkPass()">
                    </div>  
                      <!-- Tombol -->
                    </div>
                    <div class="col-md-3 d-flex align-items-end mb-2 justify-content-start">
                      <button type="submit" id="save" name="save" class="btn btn-sm btn-primary">Update</button>
                    </div>
              </div>
            </div>
          </div>
...
function checkPass(){
   if($("#new_password").val() != "" && $("#confirm_password").val() != ""){
     if($("#new_password").val() === $("#confirm_password").val()){
      $("#new_passwrod").removeClass("is-invalid");
      $("#confirm_password").removeClass("is-invalid");
       $('#save').prop('disabled', false);
     }else{
      $("#new_passwrod").addClass("is-invalid");
