    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            ...
            <div class="ms-md-auto py-2 py-md-0">
                @can($permission_add)
                    <a href="{{ route('custom-quality-management-tambah', ['tab' => request('tab')]) }}"
...
@push('bottom')
    ...
    <script>
        function viewDelete(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-quality-management-delete', ':id') }}".replace(':id',
        ...
        function viewShare(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-quality-management-share', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewPdf(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-quality-management-pdf', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewHistory(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-quality-management-history', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
