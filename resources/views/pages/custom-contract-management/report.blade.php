    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            ...
            <div class="ms-md-auto py-2 py-md-0">
                @can('add_contract_management')
                    <a href="{{ route('custom-contract-management-tambah', ['tab' => request('tab')]) }}"
...
@push('bottom')
    ...
    <script>
        function viewDelete(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-contract-management-delete', ':id') }}".replace(':id',
        ...
        function viewShare(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-contract-management-share', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewPdf(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-contract-management-pdf', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
        ...
        function viewHistory(param) {
            ...
            $(".modal-content").html("");
            $.ajax({
                url: "{{ route('custom-contract-management-history', ':id') }}".replace(':id',
                param), // Ganti dengan route yang sesuai
                type: "GET",
                data: {
                    tab: tab
