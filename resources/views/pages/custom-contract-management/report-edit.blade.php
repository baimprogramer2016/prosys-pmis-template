        ...
        <div class="card-body">
          ...
          <div class="align-items-center mb-3 mt-3   p-3 row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" id="no_contract" name="no_contract" value="{{$document->no_contract}}">
            </div>
            <div class="col-md-6 mb-3">
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    ...
    $.ajax({
      url: "{{ route('custom-contract-management-update-uploads',':id') }}".replace(':id', id_edit),
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
