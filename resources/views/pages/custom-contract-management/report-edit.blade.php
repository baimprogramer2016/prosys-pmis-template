    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2">Contract Management / {{ Ucwords(str_replace('_', ' ', request('tab'))) }} / Edit</h6>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <form action="{{ route('custom-contract-management-upload-temp') }}" class="dropzone mt-3"
                                    id="myDropzone">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <textarea class="form-control" id="no_contract" name="no_contract" placeholder="Nomor Kontrak">{{ $document->no_contract }}</textarea>

                                </div>
                                <div class=" mb-3">
                                    <label for="start_date" class="form-label strong">Title</label>
                                    <textarea class="form-control" id="title" name="title" placeholder="Title">{{ $document->title }}</textarea>
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (valid == true) {
                ...
                $.ajax({
                    url: "{{ route('custom-contract-management-update-uploads', ':id') }}".replace(':id',
                        id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
