  ...
  <div class="modal-body">
    <form id="formData">
      <div class="mb-3">
        ...
        <input type="text" readonly class="form-control" value="{{ $document->no_contract }}">
  ...
  <script>
    ...
    $("#deleteData").on("click", function() {
      ...
      let tab = $("#tab").val();
        ...
        $.ajax({
          url: "{{ route('custom-contract-management-deleted', ':id') }}".replace(':id', dataId), // Ganti dengan route yang sesuai
