                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <textarea class="form-control" id="no_contract" name="no_contract" placeholder="Nomor Kontrak"></textarea>

                                </div>
                                <div class="mb-3">
                                    <label for="start_date" class="form-label strong">Title</label>
                                    <textarea class="form-control" id="title" name="title" placeholder="Judul Dokumen"></textarea>
                                </div>
