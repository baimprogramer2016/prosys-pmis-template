        ...
        <div class="card">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center">
              ...
              <input type="date" id="tanggal_awal" class="form-control form-control-sm me-3" style="width: 150px;">
              
              <label for="end_date" class="me-2 mb-0">Tanggal Akhir:</label>
              <input type="date" id="tanggal_akhir" class="form-control form-control-sm me-3" style="width: 150px;">
...
$("#filterBtn").click(function() {
  ...
  if(valid) {
    ...
    showChart($("#tanggal_awal").val(),$("#tanggal_akhir").val());
  }
...
showChart('', '')
function showChart(param_tgl_awal, param_tgl_akhir){
    ...
    var myBarChart = new Chart(ctx, {
        ...
        options: {
          ...
          datalabels: {
            ...
            align: 'top',           // Perataan label di atas bar
