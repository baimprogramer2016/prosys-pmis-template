  ...
  <div class="modal-body">
    <form id="formData">
      <div class="mb-3">
        ...
        <input type="text" readonly class="form-control" value="{{ $document->description.'| Tanggal : '.$document->tanggal }}">
      </div>
    </form>
  </div>
  ...
  <script>
    ...
    $("#deleteData").on("click", function() {
      ...
      let dataId = $("#data_id").val();
        ...
        $.ajax({
          url: "{{ route('s-curve-deleted', ':id') }}".replace(':id', dataId), // Ganti dengan route yang sesuai
