        ...
        <div class="card-body">
          ...
          <div class="align-items-center mb-3 mt-3   p-3 row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" id="typeofmeeting" name="typeofmeeting" value="{{$document->typeofmeeting}}">
            </div>
           
            <div class="col-md-6 mb-3">
              <label for="start_date" class="form-label strong">Meeting Location</label>
              <input type="text" class="form-control" id="meetinglocation" name="meetinglocation" value="{{$document->meetinglocation}}">
            </div>
