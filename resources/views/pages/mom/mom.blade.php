...
<div class="page-inner">
    ...
    >
      ...
      <div class="ms-md-auto py-2 py-md-0">
        <a href="{{ route('mom-tambah') }}"  class="btn btn-primary btn-round">Tambah</a>
       </div>
    </div>
    <div class="row">
...
function viewDelete(param){
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('mom-delete', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    headers: {
...
function viewShare(param){
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('mom-share', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    },
 ...
 $(document).ready(function() {
  var table = $('.table').DataTable({
          ...
          columns: [
              ...
              { data: 'typeofmeeting', name: 'typeofmeeting' },
              { data: 'meetinglocation', name: 'meetinglocation' },
