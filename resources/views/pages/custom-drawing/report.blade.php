...
<div class="page-inner">
    ...
    >
      ...
      <div class="ms-md-auto py-2 py-md-0">
        <a href="{{ route('custom-drawing-tambah',["tab" => request('tab')]) }}"  class="btn btn-primary btn-round">Tambah</a>
       </div>
    </div>
    <div class="row">
...
function viewDelete(param){
  ...
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('custom-drawing-delete', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
      },
...
function viewShare(param){
  ...
  $(".modal-content").html("");
$.ajax({
  url: "{{ route('custom-drawing-share', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
      },
...
function viewPdf(param){
  ...
  $(".modal-content").html("");
  $.ajax({
    url: "{{ route('custom-drawing-pdf', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
      type: "GET",
      data: {
        tab:tab 
      },
 ...
 $(document).ready(function() {
  var table = $('.table').DataTable({
          ...
          language : {
            ...
            ajax: {
                url: "{{ route('get-custom-drawing', ['tab' => request('tab')]) }}",
            },
...
function viewHistory(param){
  ...
  $(".modal-content").html("");
  $.ajax({
  url: "{{ route('custom-drawing-history', ':id') }}".replace(':id', param), // Ganti dengan route yang sesuai
    type: "GET",
    data: {
        tab:tab 
    },
