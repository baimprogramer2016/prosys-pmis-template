    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row  pb-2">
            <div class="d-flex align-items-center gap-4">
                ...
                <h6 class="op-7 mb-2">Correspondence / Surat Masuk</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
                {{-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a> --}}
                <a href="{{ route('surat-masuk') }}" class="btn btn-primary btn-round">Daftar</a>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <input type="text" class="form-control" id="typeofincomingdocument"
                                        name="typeofincomingdocument" value="{{ $document->typeofincomingdocument }}">
                                </div>
                                <div class=" mb-3">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <option value="{{ $document->status }}"> {{ Ucwords($document->status) }}
                                        </option>
...
@push('bottom')
    ...
    <script>
        ...
        document.getElementById('saveUploads').addEventListener('click', function() {
            ...
            if (typeofincomingdocument === "") {
                $("#typeofincomingdocument").addClass("is-invalid");
                valid = false;
            }
            if (from === "") {
            ...
            if (valid == true) {
                $.ajax({
                    url: "{{ route('surat-masuk-update', ':id') }}".replace(':id', id_edit),
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
