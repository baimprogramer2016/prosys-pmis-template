    ...
    <div class="row">
      ...
      <div class="card ">   
        <div class="card-body">
          ...
          <form action="{{ route('surat-masuk-upload-temp')}}" class="dropzone mt-3" id="myDropzone">
          ...
          <div class="align-items-center mb-3 mt-3   p-3 row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" id="typeofincomingdocument" name="typeofincomingdocument">
            </div>
            <div class="col-md-6 mb-3">
...
document.getElementById('saveUploads').addEventListener('click', function () {
  ...
  if(valid == true){
    $.ajax({
      url: "{{ route('surat-masuk-save-uploads') }}",
      type: "POST",
      data: {
        _token: "{{ csrf_token() }}",
